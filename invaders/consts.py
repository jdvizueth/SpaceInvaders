...
### SHIP CONSTANTS ###
# the image used for the ship
SHIP_IMAGE = 'ship.png'
# the images used for the explosion of the ship
SHIP_ANIMATION = 'ship-strip.png'
# the speed of how fast the explosion animation occurs
DEATH_SPEED = 0.3
